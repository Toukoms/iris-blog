	...
	return (
		<div className="h-fit w-full rounded-lg border bg-base-300 p-4 px-8 pb-6 text-left no-underline shadow-sm">
			<div className="flex gap-4">
				...
				<div>
					<Link
						...
						className="my-0 mt-4 line-clamp-1 w-full font-bold text-accent text-xl tracking-wider"
					>
						{authorName}
					</Link>
			...
			<div>
				<Link
					href={`/article/${id}`}
					className="my-0 mt-4 block font-semibold text-lg"
				>
					{title}
				</Link>

				<div className="mt-2 mb-4 line-clamp-4 text-lg">
					{description ? (
						description
					) : (
