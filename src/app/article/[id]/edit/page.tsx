  ...
  useEffect(() => {
    if (articleQuery.isSuccess && articleQuery.data) {
      ...
      setFormData({
        ...
        markdownContent: articleQuery.data.markdownContent as string,
        jsonContent: articleQuery.data.jsonContent as string,
        published: articleQuery.data.published,
      });
    } else if (articleQuery.isError || articleQuery.data === null) {
      router.back();
    }
  }, [articleQuery.data, articleQuery.isSuccess, articleQuery.isError, router]);
